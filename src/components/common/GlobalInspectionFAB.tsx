...
const GlobalInspectionFAB = () => {
  const router = useRouter();
  const pathname = usePathname();
  const { hasSelectedProperties, selectedCount } = useGlobalInspectionState();

  // Don't show FAB on the continue-inspection page itself
...
export default GlobalInspectionFAB;
