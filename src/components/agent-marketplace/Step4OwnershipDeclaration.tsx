          ...
          <div className='bg-[#F8F9FA] rounded-lg p-6 space-y-4'>
            <div className='flex items-start gap-3'>
              ...
              <label className='text-[14px] text-[#1E1E1E] leading-relaxed'>
                I confirm that I am authorized to list this property and that all information provided is accurate and truthful.
              </label>
            </div>
            ...
            <div className='flex items-start gap-3'>
              ...
              />
              <label className='text-[14px] text-[#1E1E1E] leading-relaxed'>
                I agree to KhabiTeq's terms and conditions and authorize the marketing of this property on the platform.
              </label>
            </div>
            ...
            <div className='flex items-start gap-3'>
              ...
              />
              <label className='text-[14px] text-[#1E1E1E] leading-relaxed'>
                I consent to the collection and use of my personal data for property listing and communication purposes.
              </label>
            </div>
          </div>
          
          {((formik.touched.agreeToTerms && formik.errors.agreeToTerms) ||
            (formik.touched.agreeToMarketing && formik.errors.agreeToMarketing) ||
            (formik.touched.agreeToDataUsage && formik.errors.agreeToDataUsage)) && (
            <div className='text-red-600 text-sm space-y-1'>
              {formik.touched.agreeToTerms && formik.errors.agreeToTerms && (
