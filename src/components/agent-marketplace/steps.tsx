...
const Sell: React.FC<SellProps> = ({ briefId, onClose, buyerPreference }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      ownerPhoneNumber: Yup.string().test(
        "is-valid-phone",
                ...
                <div>
                        ...
                        <div className="grid grid-cols-3 gap-x-8 text-sm">
                          ...
                          <div className="space-y-6">
                            <div>
                              ...
                              <div className="text-black font-semibold">
                                {buyerPreference?.referenceId || "-"}
                              </div>
                            </div>
                            <div>
                              <div className="text-gray-600 mb-1">Date</div>
                              <div className="text-black">
                                {buyerPreference?.date || "-"}
                              </div>
                            </div>
                            <div>
                              <div className="text-gray-600 mb-1">
                          ...
                          <div className="space-y-6">
                            <div className="text-right">
                              <div className="text-black font-semibold">
                                {buyerPreference?.propertyPriceRange || "-"}
                              </div>
                            </div>
                            <div></div>
                            <div></div>
                  ...
                  <div className="lg:w-[953px] w-full flex flex-col justify-center gap-[15px] mt-[20px]">
                    ...
                    <div className="lg:w-[953px] w-full text-xl text-[#FF3D00] font-normal text-center mt-5">
                      Note: Only property owners and mandated agents are allowed
                      to submit listings. Submissions from non-owners will be
                    ...
                    <div className="w-full min-h-[348px] flex flex-col gap-[20px] py-[40px] lg:px-[80px]">
                      ...
                      <div className="w-full flex flex-col gap-[15px] min-h-[270px] ">
                        ...
                        <p className='font-["Roboto"] font-medium text-[18px] leading-[160%] text-[#1976D2]'>
                          ...
                          Khabi-Teq Realty, its affiliates, directors, and
                          agents from and against any and all claims, losses,
                          liabilities, or damages arising from or related to any
                          transaction conducted by me on its platform
                        </p>
                      </div>
                    </div>
                  )}
...
const SuccessBriefModal: React.FC<SuccessBriefModalProps> = ({
  open,
  onClose,
  onYes,
  onNo,
      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-8 flex flex-col items-center relative">
        ...
        <div className="text-center w-full">
          ...
          <div className="font-semibold text-lg mb-1">
            Got similar property brief to share?
          </div>
          <div className="text-gray-500 mb-6">
            Add more property brief that matches this request!
          </div>
          <button
