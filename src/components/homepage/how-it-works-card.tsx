...
const Card = ({ heading, detailsArr }: CardProps) => {
  return (
    <motion.div
      ...
      className="w-full sm:w-[280px] md:w-[313px] h-[389px] shrink-0 flex flex-col justify-center items-center gap-[10px] py-[24px] px-[18px] border-[1px] border-[#FFFFFFFF] backdrop-blur-md"
    >
...
const Rectangle = ({ index, text }: { index: number; text: string }) => {
  return (
    <div
      className="w-full h-[57px] py-[10px] px-[15px] flex items-center gap-[14px] border-[1px] border-white backdrop-blur-md"
      style={{
