...
const Card = ({ heading, detailsArr }: CardProps) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className='md:w-[313px] w-full h-[389px] shrink-0 flex flex-col justify-center items-center gap-[10px] py-[24px] px-[18px] border-[1px] border-[#FFFFFFFF] bg-white/5 backdrop-blur-md'>
