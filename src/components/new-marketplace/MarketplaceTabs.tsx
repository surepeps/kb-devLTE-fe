      ...
      <div className="md:hidden mb-6 px-4">
        <div className="relative">
          <button
            ...
            className="w-full bg-white border-2 border-gray-200 rounded-lg px-4 py-3 flex items-center justify-between text-[#5A5D63] font-medium text-sm hover:border-[#8DDB90] transition-colors"
          >
            <span>{activeTabData?.label || "Select property type"}</span>
            <FiChevronDown
