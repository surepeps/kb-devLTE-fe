      ...
      <div className="container min-h-[700px] flex flex-col justify-center items-center gap-[20px] px-[20px] overflow-hidden">
        <div className="min-h-[128px] w-full lg:w-[870px] flex flex-col justify-center items-center gap-[9px] pt-[40px]">
          ...
          <p className="text-[#5A5D63] text-[18px] leading-[28.8px] tracking-[5%] font-normal text-center">
            Your trusted partner in Lagos&apos; real estate market. Since 2020, we&apos;ve been delivering expert
            solutions with integrity and personalized service, helping you navigate property sales, rentals, and more.
              ...
              return (
                <Card
                  ...
                  onClick={() => {
                    ...
                    const existingBriefs = JSON.parse(localStorage.getItem('selectedBriefs') || '[]');

                    // Ensure it's an array and add the new property
                    const updatedBriefs = Array.isArray(existingBriefs) ? [...existingBriefs, property] : [property];
        ...
        <div className="flex justify-center items-center mt-6">
          ...
          >
            <span className="text-base text-[#09391C] leading-[25px] font-semibold">Show more</span>{' '}
            <Image src={arrowIcon} width={12} height={15} alt="" className="w-[12px] h-[15px]" />
          </button>
        </div>
      </div>
    </section>
