...
interface UpdateJointVenturePropertyFormProps {
  pageTitle: string;
  pageDescription: string;
}

const UpdateJointVenturePropertyForm: React.FC<UpdateJointVenturePropertyFormProps> = ({
  pageTitle,
  pageDescription,
}) => {
  ...
  // Override the form to use update mode
  const updatedPageTitle = pageTitle;
  const updatedPageDescription = pageDescription;
...
export default UpdateJointVenturePropertyForm;
