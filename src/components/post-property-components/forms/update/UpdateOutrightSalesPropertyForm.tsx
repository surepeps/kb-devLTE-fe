...
interface UpdateOutrightSalesPropertyFormProps {
  pageTitle: string;
  pageDescription: string;
}

const UpdateOutrightSalesPropertyForm: React.FC<UpdateOutrightSalesPropertyFormProps> = ({
  pageTitle,
  pageDescription,
}) => {
...
export default UpdateOutrightSalesPropertyForm;
