        ...
        <div className='h-[428px] w-full bg-[#FFFFFF] rounded-[4px] py-[40px] px-[20px] md:px-[80px] flex flex-col justify-center items-center gap-[25px]'>
          <div className='flex flex-col gap-[42px]'>
            ...
            <div className='h-[129px] w-full flex flex-col gap-[15px]'>
              <button
                type='button'
                className={`h-[57px] border-[1px] border-[#E9EBEB] w-full hover:bg-gray-200 bg-white transition duration-500 rounded-[5px] font-medium text-lg text-[#FB1515] ${archivo.className}`}>
                Delete Brief
              </button>
              <button
                onClick={() => {
