          ...
          <div className='flex flex-col gap-[42px]'>
            ...
            <div className='h-[129px] w-full flex flex-col gap-[15px]'>
              <button
                onClick={onConfirm}
                type='button'
                className={`h-[57px] w-full bg-[#FB7515] hover:bg-[#C94A00] transition duration-500 rounded-[5px] font-bold text-lg text-white ${archivo.className}`}>
                Confirm
              </button>
              <button
                onClick={onCancel}
