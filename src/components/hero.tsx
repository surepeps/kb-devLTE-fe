    ...
    <section className='flex items-center justify-center min-h-[536px] w-full overflow-hidden pt-[20px]'>
      <div className='container h-full flex md:flex-row flex-col px-[20px] slide-from-bottom'>
        <div
          ...
          <Button
            green={true}
            className='h-[66px] w-full lg:w-[393px] py-[12px] px-[24px] text-white text-[16px] leading-[32px] font-bold'
            value={buttonText1}
            onClick={() => {
          ...
          <Button
            green={false}
            className='h-[66px] w-full lg:w-[393px] py-[12px] px-[24px] text-[#8DDB90] text-[16px] leading-[32px] font-bold border-[2px] border-[#8DDB90]'
            value={buttonText2}
            onClick={() => {
