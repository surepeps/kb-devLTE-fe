...
const UpdateProperty = () => {
  ...
  const getStepTitle = () => {
    ...
    return steps[currentStep]?.label || "Update Property";
  };
  ...
  return (
    <AgentAccessBarrier
      ...
      customMessage="You must complete onboarding and be approved before you can update properties."
    >
            ...
            <p className="text-[#5A5D63] text-sm md:text-lg max-w-2xl mx-auto px-4">
              {showPropertySummary
                ...
                : showCommissionModal
                  ...
                  : "Update your property information to keep your listing current and attractive to potential buyers or tenants"}
            </p>
          </div>
