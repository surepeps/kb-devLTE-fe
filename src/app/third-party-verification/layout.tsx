      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Document Verification Portal</h1>
              <p className="text-[#8DDB90] font-medium">Secure • Trusted • Verified</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-6">
            {/* SSL Indicator */}
            <div className="flex items-center space-x-2 bg-[#8DDB90] px-4 py-2 rounded-full">
