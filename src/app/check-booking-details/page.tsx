    ...
    <div className="min-h-screen bg-[#EEF1F1]">
      <div className="mx-auto max-w-3xl px-4 py-6">
        <div className="flex items-center justify-between mb-4">
          <Link href="/" className="inline-flex items-center gap-2 text-[#09391C]">
            <ArrowLeft size={18} /> Home
          </Link>
          {view === "details" && (
            <div className="flex items-center gap-2 text-xs text-gray-600">
              <span className="rounded bg-white border border-gray-200 px-2 py-1">Session: {mmss}</span>
              <button onClick={clearSession} className="inline-flex items-center gap-1 px-2 py-1 bg-red-50 text-red-700 border border-red-200 rounded">
        ...
        {view === "form" && (
          <div className="w-full max-w-xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={loading} className="w-full inline-flex items-center justify-center gap-2 bg-[#09391C] text-white py-3 px-4 rounded-lg font-semibold hover:bg-[#0B423D] disabled:opacity-60">
                {loading ? (
