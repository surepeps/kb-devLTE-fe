...
export default function MyInspectionRequestsPage() {
  ...
  const calculateMetrics = useCallback((data: InspectionData[]) => {
    const metrics: MetricsData = {
      ...
      pendingInspections: data.filter((item) => item.status === "pending")
        .length,
      approvedInspections: data.filter(
        (item) => item.status === "inspection_approved",
      ).length,
  ...
  const filterInspections = useCallback(() => {
    ...
    if (filters.inspectionType) {
      filtered = filtered.filter(
        (inspection) => inspection.inspectionType === filters.inspectionType,
      );
    }
    ...
    if (filters.dateFrom) {
      filtered = filtered.filter(
        (inspection) =>
          new Date(inspection.createdAt) >= new Date(filters.dateFrom),
      );
    }
    ...
    if (filters.dateTo) {
      filtered = filtered.filter(
        (inspection) =>
          new Date(inspection.createdAt) <= new Date(filters.dateTo),
      );
    }
    ...
    if (filters.priceRange.min) {
      filtered = filtered.filter(
        (inspection) =>
          inspection.propertyId.price >= parseInt(filters.priceRange.min),
      );
    }
    ...
    if (filters.priceRange.max) {
      filtered = filtered.filter(
        (inspection) =>
          inspection.propertyId.price <= parseInt(filters.priceRange.max),
      );
    }
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                {inspection.counterCount > 0 && (
                                  <span className="px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                                    {inspection.counterCount} Counter
                                    {inspection.counterCount !== 1 ? "s" : ""}
                                  </span>
                                )}
                              </div>
                              ...
                              {inspection.negotiationPrice && (
                                <p className="text-sm text-orange-600 font-medium">
                                  Offered Price: ₦
                                  {inspection.negotiationPrice.toLocaleString()}
                                </p>
                              )}
                            </div>
                          ...
                          <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-100">
                            ...
                            <button
                              onClick={() =>
                                router.push(
                                  `/property/${inspection.propertyId.propertyCategory}/${inspection.propertyId._id}`,
                                )
                              }
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm bg-gray-50 p-4 rounded-lg">
                    <div>
                      ...
                      <p className="mt-1">
                        {selectedInspection.propertyId.title}
                      </p>
                    </div>
                    <div>
                      <span className="font-medium text-gray-600">Type:</span>
                      <p className="mt-1">
                        {selectedInspection.propertyId.propertyType}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="mt-1">
                        {selectedInspection.propertyId.propertyCategory}
                      </p>
                    </div>
                    <div>
                      <span className="font-medium text-gray-600">Price:</span>
                      <p className="mt-1 font-medium text-[#8DDB90]">
                        ₦{selectedInspection.propertyId.price.toLocaleString()}
                      </p>
                    </div>
                    <div className="md:col-span-2">
                      ...
                      <p className="mt-1">
                        {selectedInspection.propertyId.location.area},{" "}
                        {selectedInspection.propertyId.location.localGovernment}
                        , {selectedInspection.propertyId.location.state}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="mt-1 capitalize">
                        {selectedInspection.inspectionMode}
                      </p>
                    </div>
                    <div>
                      <span className="font-medium text-gray-600">Type:</span>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm bg-blue-50 p-4 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="mt-1">
                          {selectedInspection.counterCount}
                        </p>
                      </div>
                      <div>
                        <span className="font-medium text-blue-700">
                        ...
                        <p className="mt-1 capitalize">
                          {selectedInspection.pendingResponseFrom}
                        </p>
                      </div>
                    </div>
                  </div>
