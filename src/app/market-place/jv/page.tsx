...
import JointVentureSearch from "@/components/marketplace/joint-venture-search";
      ...
      <div className="container mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="text-center mb-6 md:mb-8">
          <nav className="text-sm text-[#5A5D63] mb-4">
            ...
            <span className="mx-2">›</span>
            <span className="text-[#09391C] font-medium">Joint Venture</span>
          </nav>
          ...
          <p className="text-sm md:text-lg text-[#5A5D63] max-w-2xl mx-auto">
            Explore joint venture opportunities. Partner with property owners
            and investors for mutual growth.
          </p>
        </div>
