...
import BuyPropertySearch from "@/components/marketplace/buy-property-search";
      ...
      <div className="container mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="text-center mb-6 md:mb-8">
          <nav className="text-sm text-[#5A5D63] mb-4">
            ...
            <span className="mx-2">›</span>
            <span className="text-[#09391C] font-medium">Buy a Property</span>
          </nav>
          ...
          <p className="text-sm md:text-lg text-[#5A5D63] max-w-2xl mx-auto">
            Find your perfect property investment. Browse through our curated
            list of properties available for purchase.
          </p>
        </div>
