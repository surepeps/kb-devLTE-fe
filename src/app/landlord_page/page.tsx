...
const Landlord = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      tenantCriteria: Yup.array().min(1, 'At least one tenant criteria is required'),
            ...
            <div className='min-h-[629px] py-[40px] lg:px-[80px] border-[#8D909680] border-y-[1px] w-full'>
              <div className='w-full min-h-[629px] flex flex-col gap-[46px]'>
                ...
                <div className='min-h-[73px] gap-[15px] flex flex-col lg:w-[535px] w-full'>
                  ...
                  <div className='w-full gap-[20px] lg:gap-[50px] flex flex-row flex-wrap'>
                    <RadioCheck
                      isDisabled={formik.values?.propertyCondition ? true : false}
                      selectedValue={formik.values?.propertyCondition}
                      handleChange={() => {
                        formik.setFieldValue('propertyCondition', 'New Building');
                      }}
                      type='radio'
                    ...
                    <RadioCheck
                      ...
                      selectedValue={formik.values?.propertyCondition}
                      handleChange={() => {
                        formik.setFieldValue('propertyCondition', 'Old Building');
                      }}
                      type='radio'
                      name='propertyCondition'
                      value='Old Building'
                  ...
                  <div className='grid lg:grid-cols-2 gap-[15px] w-full'>
                    {tenantCriteriaData.map((item: string, idx: number) => (
                      <RadioCheck
                        ...
                        name='tenantCriteria'
                        handleChange={() => {
                          const tenantCriteria = formik.values.tenantCriteria.includes(
                            item
                          )
